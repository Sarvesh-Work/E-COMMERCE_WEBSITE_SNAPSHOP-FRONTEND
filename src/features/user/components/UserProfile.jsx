    ...
    <>
      ...
      <div className=" container-lg container-fluid">
        ...
        <div className="row mt-1 p-md-3 d-flex justify-content-center align-items-center" >
          <div
            className="col-md-9 col-12 p-2 box" 
            >
            <div
              className="d-flex"
            ...
            <div className="mt-2 px-2">
              {showAddAddress ? (
                <div className="p-1 mt-2">
                  <h5 className="py-1" style={{borderBottom:"1px solid #cccc"}}>New Address</h5>
                  <form
                    noValidate
              ...
              <h5 className="mt-2 py-2" style={{borderTop:"1px solid #cccc"}}>Existing  address:</h5>
