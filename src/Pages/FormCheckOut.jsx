...
import { selectUserInfo, updateUserAsync } from "../features/user/userSlice.jsx";
      ...
      >
        ...
        >
          <div style={{ borderBottom: "1px solid  #B6B6B4" }}>
            ...
            <div className="mb-3 d-flex gap-3 w-100 mx-auto">
              <div>
              ...
              {!user.address[0]
                ...
                : user.address?.map((data, index) => (
                  ...
                  >
                    ...
                    <div className=" col-11  my-1  d-sm-flex justify-content-center align-items-center">
                      <div className="">
                      ...
                      <div className="ms-auto px-sm-3  ">
                        <div className="text-md-end">Phone: {data.Phone_number}</div>
                        <div className="text-md-end">State: {data.State}</div>
                        <div className="text-md-end">Address: {data.Address}</div>
                      </div>
