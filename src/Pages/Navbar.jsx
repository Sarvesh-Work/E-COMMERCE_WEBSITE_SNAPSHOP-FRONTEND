...
const Navbar = ({ children }) => {
  ...
  return (
    <>
      ...
      >
        {search == true ? (
          <div className="w-75 mx-auto d-flex gap-2">
            <i
              className="fa-solid fa-arrow-left mt-2"
              style={{ fontSize: "18px" }}
            ...
            ></input>
            <i className="fas fa-search mt-2" style={{ fontSize: "18px" }}></i>
          </div>
        ) : (
          <div className="container-lg container-fluid px-1 py-lg-0 py-1">
            ...
            <div className=" gap-md-3 gap-2 h-100  d-flex mt-lg-1 py-0 px-2">
              <div className="text-decoration-none mt-1 cursor d-lg-none d-block">
                <i
              ...
              <div className="btn-group dropstart p-1 mt-lg-0  cursor">
                <div
                  className="dropdown"
